...
**What the data shows.** Attrition ranges from 7.5% to 15.0% across legacy entities — a 2.0x spread between otherwise-similar populations (engagement differs by <0.1 pt). 'Entity_B' loses people at 1.4x the company average, and it sits on a separate legacy HR system (BambooHR-EntityB) — the signature of an acquisition bolted on but never operationally integrated.
