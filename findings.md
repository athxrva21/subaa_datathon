...
> NovaCorp isn't losing a talent war — most departures are **internally driven rather than poached**, the damage is **concentrated in specific acquired entities**, and the usable warning sign is **behavioural, not attitudinal** (the people who leave were *always* quieter on surveys, from their very first wave) — which makes a large share of the $42M **addressable**.

*Restated 14 Aug. Two claims in the original version were wrong as written and are corrected below: the "68% push, therefore preventable" framing (finding 2) and the "people go silent before they quit" framing (finding 5). See A14 and A12 §4.*
...
**What the data shows.** 955 of 1,400 exits (68%) are classed 'push', 445 (32%) 'pull'. **But the brief defines push as involuntary *or managed*, not disengagement-driven**, and 267 of those 955 are literally involuntary — 196 recorded as "Involuntary – performance", 50 as restructure. Excluding them, **688 of 1,133 voluntary exits (60.7%)** are push. 'Career advancement' is the #1 stated reason at 428. And 37% of leavers (523 people) are High Performers or Outstanding.

**So what.** The dominant lever is internal (engagement, managers, growth) rather than compensation to fight poachers. But an involuntary exit is a decision the company made, not a loss it suffered, so it cannot be counted as preventable attrition.

*Corrected 14 Aug. The original read "68% of exits are 'push' (disengagement-driven)" and treated the whole 68% as preventable. Push is not a synonym for disengagement-driven, and the 267 involuntary exits inside it are not preventable losses. See A6 §1.5.*
...
### 5. THE standout signal: low response separates leavers from stayers, and it does so from day one
**What the data shows.** Employees in the lowest survey-response band leave at 30.6% versus 5.2% for consistent responders — a ~6x spread, and a far sharper separator than the engagement scores themselves. **This gap is present from the very first wave and does not widen.** Leavers respond at 70.6% in wave 1 and 70.3% in wave 5. Stayers go 84.9% to 80.5%. The gap actually *narrows*, from 14.4pt to 10.2pt.

**So what.** Non-response is not missing data — it IS the data. But it is a **stable trait, not a decline to detect**: any early-warning system built to spot someone *going* quiet will never fire, because they were quiet on arrival. Measure against the company baseline from an employee's first survey instead.

⚠️ **Do not deploy this as an individual flight-risk score.** It fails the four-fifths rule on age (impact ratio 0.15), role level and acquisition cohort, and its precision is 23%. Team-level diagnostic only, disclosed to staff. See the ethics workstream and deck slides 12–13.

*Corrected 14 Aug. The original claimed the gap widened wave over wave and framed this as people going silent before quitting. The data shows the opposite: the gap is widest at wave 1 and narrows. See A12 §4.*
...
**What the data shows.** **Superseded by the costing engine.** All dollar figures now come from `ethics_finance/cost_model.py` on the brief's own constants (1.5× replacement, 85% backfill, 12% super). On that basis the value-based regrettable-attrition bucket is **$45.1M/yr**, disengagement **$17.8M/yr** and hiring inefficiency **$2.3M/yr**, totalling **$65.2M/yr** against Finance's $42M midpoint.
...
*Corrected 14 Aug. The original used a 0.5–1.0× replacement multiplier the brief does not specify, and derived an addressable figure by applying the 68% push share, which double-counts the involuntary exits corrected in finding 2. Superseded rather than restated, because the costing engine now produces all dollar figures. See A14.*
...
- **Push vs pull**: per the brief, push = involuntary **or managed** exit; pull = employee-initiated in response to an outside opportunity. Push is **not** a synonym for disengagement-driven, and 267 of the 955 push exits are literally involuntary.
